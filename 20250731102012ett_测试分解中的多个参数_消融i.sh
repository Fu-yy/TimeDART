...
#max_lag_inner=31
#num_scales_inner=4
#peak_threshold_inner=0.1
#distance_inner=3
#
## 测试 num_scales
#for num_scales in 1  2 3;do
#num_scales_inner=$num_scales
#for _ in 1;do
#
#
#
...
#    --distance $distance \
#    --max_lag_inner $max_lag_inner \
#    --num_scales_inner $num_scales_inner \
#    --peak_threshold_inner $peak_threshold_inner \
...
#
## 测试 max_lag_inner
#for max_lag_inner in 25 49 96;do
#for _ in 1;do
#
#
#
...
#
## 测试  peak_threshold
#for peak_threshold in 0.1 0.2 0.4;do
#for _ in 1;do
#
#
#
...
# 测试  peak_threshold_inner
for peak_threshold_inner in 0.1 0.2 0.4;do
for _ in 1;do
...
# 测试 distance_inner
for distance_inner in 1 3 5 7;do
for _ in 1;do
