...
parser.add_argument('--build_aasd', type=int, default=1)
parser.add_argument('--build_tcsr', type=int, default=1)
parser.add_argument('--profile_use_aasd', type=int, default=1)
parser.add_argument('--profile_use_tcsr', type=int, default=1)
# full / no_aasd / no_tcsr / no_aasd_no_tcsr
parser.add_argument('--ablation_mode', type=str, default="no_aasd")
...
if args.task_name == "pretrain":
    for ii in range(args.itr):
        ...
        exp.pretrain()
        exp.profile_efficiency_variants(flag="test")
