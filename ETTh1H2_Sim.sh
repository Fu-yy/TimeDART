...
python -u run.py \
    ...
    --batch_size 16 \
    --train_epochs 20 \
> ./run_log/log_test_win/ETTh2/'TimeDART_my_SimMTM_ETTh2_pretrain'0.01.log 2>&1
...
for pred_len in 96; do
    python -u run.py \
        ...
        --head_dropout 0.2 \
        --batch_size 16 \
> ./run_log/log_test_win/ETTh2/'TimeDART_my_SimMTM_ETTh2_finetune'$pred_len_0.01.log 2>&1
