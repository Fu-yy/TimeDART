...
for pred_len in  96 192 336 720; do
    python -u run.py \
        ...
        --down_sampling_layer 2 \
        --down_sampling_window 2 \
> ./run_log/log_202411241520_win/ETTh1/'TimeDART_finetune'$pred_len'_'0.01.log 2>&1
done
#
# ETTh2
#python -u run.py \
...
for pred_len in 96 192 336 720; do
    python -u run.py \
        ...
        --down_sampling_layer 2 \
        --down_sampling_window 2 \
> ./run_log/log_202411241520_win/ETTh2/'TimeDART_finetune'$pred_len'_'0.01.log 2>&1
...
#       --down_sampling_layer 2 \
#       --down_sampling_window 2 \
#> ./run_log/log_202411241520_win/ETTm1/'TimeDART_finetune'$pred_len'_'0.01.log 2>&1
#
#done
#
#
...
#       --down_sampling_layer 2 \
#       --down_sampling_window 2 \
#> ./run_log/log_202411241520_win/ETTm2/'TimeDART_finetune'$pred_len'_'0.01.log 2>&1
#
#done
...
#       --down_sampling_layer 2 \
#       --down_sampling_window 2 \
#> ./run_log/log_202411241520_win/Exchange/'TimeDART_finetune'$pred_len'_'0.01.log 2>&1
#
#done
#
##WTH
...
#    --down_sampling_layer 2 \
#    --down_sampling_window 2 \
#> ./run_log/log_202411241520_win/weather/'TimeDART_finetune'$pred_len'_'0.01.log 2>&1
#
#done
#
##Traffic
...
#    --down_sampling_layer 2 \
#    --down_sampling_window 2 \
#> ./run_log/log_202411241520_win/Traffic/'TimeDART_finetune'$pred_len'_'0.01.log 2>&1
#
#done
#
##ecl
...
#    --down_sampling_window 2 \
#        --pct_start 0.3 \
#> ./run_log/log_202411241520_win/electricity/'TimeDART_finetune'$pred_len'_'0.01.log 2>&1
#
#done