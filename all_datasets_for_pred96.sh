...
#    --batch_size 16 \
#    --train_epochs 50 \
#> ./run_log/log_test_win/ETTh1/'TimeDART_pretrain'0.01.log 2>&1
#
...
#        --learning_rate 0.0001 \
#        --pct_start 0.3 \
#> ./run_log/log_test_win/ETTh1/'TimeDART_finetune'$pred_len_0.01.log 2>&1
#done
...
python -u run.py \
    ...
    --batch_size 16 \
    --train_epochs 50 \
> ./run_log/log_test_win/ETTh2/'TimeDART_pretrain'0.01.log 2>&1
...
for pred_len in 96; do
    python -u run.py \
        ...
        --learning_rate 0.0001 \
        --pct_start 0.3 \
> ./run_log/log_test_win/ETTh2/'TimeDART_finetune'$pred_len_0.01.log 2>&1
...
#    --batch_size 64 \
#    --train_epochs 50 \
#> ./run_log/log_test_win/ETTm1/'TimeDART_pretrain'0.01.log 2>&1
#
#
#
#for pred_len in 96; do
...
#        --learning_rate 0.0001 \
#        --pct_start 0.3 \
#> ./run_log/log_test_win/ETTm1/'TimeDART_finetune'$pred_len_0.01.log 2>&1
#
#done
#
#
...
#    --batch_size 64 \
#    --train_epochs 50 \
#> ./run_log/log_test_win/ETTm2/'TimeDART_pretrain'0.01.log 2>&1
#
#
#
#for pred_len in 96; do
...
#        --learning_rate 0.0001 \
#        --pct_start 0.2 \
#> ./run_log/log_test_win/ETTm2/'TimeDART_finetune'$pred_len_0.01.log 2>&1
#
#done
#
#
...
#    --batch_size 16 \
#    --train_epochs 50 \
#> ./run_log/log_test_win/Exchange/'TimeDART_pretrain'0.01.log 2>&1
#
#
#
#for pred_len in 96; do
...
#        --learning_rate 0.0001 \
#        --pct_start 0.3 \
#> ./run_log/log_test_win/Exchange/'TimeDART_finetune'$pred_len_0.01.log 2>&1
#
#done
#
##WTH
...
#    --batch_size 16 \
#    --train_epochs 50 \
#> ./run_log/log_test_win/weather/'TimeDART_pretrain'0.01.log 2>&1
#
#
#
#for pred_len in 96; do
...
#        --pct_start 0.3 \
#> ./run_log/log_test_win/weather/'TimeDART_finetune'$pred_len_0.01.log 2>&1
#
#done
#
##Traffic
...
#    --batch_size 8 \
#    --train_epochs 50 \
#> ./run_log/log_test_win/Traffic/'TimeDART_pretrain'0.01.log 2>&1
#
#
#
#for pred_len in 96; do
...
#        --learning_rate 0.003 \
#        --pct_start 0.2 \
#> ./run_log/log_test_win/Traffic/'TimeDART_finetune'$pred_len_0.01.log 2>&1
#
#done
#
##ecl
...
#    --batch_size 16 \
#    --train_epochs 50 \
#> ./run_log/log_test_win/electricity/'TimeDART_pretrain'0.01.log 2>&1
#
#for pred_len in 96; do
#    python -u run.py \
#                --task_name finetune \
...
#        --learning_rate 0.0004 \
#        --pct_start 0.3 \
#> ./run_log/log_test_win/electricity/'TimeDART_finetune'$pred_len_0.01.log 2>&1
#
#done