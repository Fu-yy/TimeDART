...
#> ./run_log/log_202506022128_win/ETTh1/'TimeDART_pretrain'0.01.log 2>&1
#
...
#        --down_sampling_layer 2 \
#        --down_sampling_window 2 \
#> ./run_log/log_202506022128_win/ETTh1/'TimeDART_finetune'$pred_len'_'$denoise_layers_num'_'0.01.log 2>&1
#done
...
python -u run.py \
    ...
    --down_sampling_layer 2 \
    --down_sampling_window 2 \
> ./run_log/log_202506022128_win/ETTh2/'TimeDART_pretrain'0.01.log 2>&1
...
echo "ETTh2 $denoise_layers_num _ $pred_len"
    ...
    python -u run.py \
        ...
        --down_sampling_layer 2 \
        --down_sampling_window 2 \
> ./run_log/log_202506022128_win/ETTh2/'TimeDART_finetune'$pred_len'_'$denoise_layers_num'_'0.01.log 2>&1
...
python -u run.py \
    ...
    --down_sampling_layer 2 \
    --down_sampling_window 2 \
> ./run_log/log_202506022128_win/ETTm1/'TimeDART_pretrain'0.01.log 2>&1
...
python -u run.py \
    ...
    --down_sampling_layer 2 \
    --down_sampling_window 2 \
> ./run_log/log_202506022128_win/ETTm2/'TimeDART_pretrain'0.01.log 2>&1
...
python -u run.py \
    ...
    --down_sampling_layer 2 \
    --down_sampling_window 2 \
> ./run_log/log_202506022128_win/weather/'TimeDART_pretrain'0.01.log 2>&1
...
echo "Weather $denoise_layers_num _ $pred_len"
    ...
    --down_sampling_layer 2 \
    --down_sampling_window 2 \
> ./run_log/log_202506022128_win/weather/'TimeDART_finetune'$pred_len'_'$denoise_layers_num'_'0.01.log 2>&1
