...
class Exp_TimeDART(Exp_Basic):
    def __init__(self, args):
        ...
        self.writer = SummaryWriter(PROJECT_PATH + os.sep + "outputs"+ os.sep+"logs")
    ...
    def pretrain(self):
        ...
        path = PROJECT_PATH+ os.sep+'outputs'+os.sep+self.args.pretrain_checkpoints+ os.sep  +self.args.data
        ...
        for epoch in range(self.args.train_epochs):
            ...
            if not min_vali_loss or vali_loss <= min_vali_loss:
                ...
                for k, v in self.model.state_dict().items():
                    if "encoder" in k or "enc_embedding" in k or "denoising_patch_decoder" in k:
                ...
                torch.save(encoder_ckpt,path+os.sep+"ckpt_best.pth")
            ...
            if (epoch + 1) % 10 == 0:
                ...
                save_path =path+ os.sep+ f"ckpt{epoch + 1}.pth"
                torch.save(encoder_ckpt, save_path )
    ...
    def train(self, setting):
        ...
        path =  PROJECT_PATH+ os.sep + self.args.checkpoints +setting
        if not os.path.exists(path):
            os.makedirs(path)
