...
if [ ! -d "./run_log/log_202601252110012_win" ]; then
    mkdir ./run_log/log_202601252110012_win
fi
if [ ! -d "./run_log/log_202601252110012_win/ETTm1" ]; then
    mkdir ./run_log/log_202601252110012_win/ETTm1
fi
if [ ! -d "./run_log/log_202601252110012_win/ETTh1" ]; then
    mkdir ./run_log/log_202601252110012_win/ETTh1
fi
if [ ! -d "./run_log/log_202601252110012_win/ETTm2" ]; then
    mkdir ./run_log/log_202601252110012_win/ETTm2
fi

if [ ! -d "./run_log/log_202601252110012_win/ETTh2" ]; then
    mkdir ./run_log/log_202601252110012_win/ETTh2
fi
if [ ! -d "./run_log/log_202601252110012_win/electricity" ]; then
    mkdir ./run_log/log_202601252110012_win/electricity
fi

if [ ! -d "./run_log/log_202601252110012_win/Exchange" ]; then
    mkdir ./run_log/log_202601252110012_win/Exchange
fi

#if [ ! -d "./run_log/log_202601252110012_win/Solar" ]; then
#    mkdir ./run_log/log_202601252110012_win/Solar
#fi

if [ ! -d "./run_log/log_202601252110012_win/weather" ]; then
    mkdir ./run_log/log_202601252110012_win/weather
fi

if [ ! -d "./run_log/log_202601252110012_win/Traffic" ]; then
    mkdir ./run_log/log_202601252110012_win/Traffic
fi
#
#if [ ! -d "./run_log/log_202601252110012_win/PEMS03" ]; then
#    mkdir ./run_log/log_202601252110012_win/PEMS03
#fi
#
#if [ ! -d "./run_log/log_202601252110012_win/PEMS04" ]; then
#    mkdir ./run_log/log_202601252110012_win/PEMS04
#fi
#
#if [ ! -d "./run_log/log_202601252110012_win/PEMS07" ]; then
#    mkdir ./run_log/log_202601252110012_win/PEMS07
#fi
#if [ ! -d "./run_log/log_202601252110012_win/PEMS08" ]; then
#    mkdir ./run_log/log_202601252110012_win/PEMS08
#fi
...
echo "maskretio WTH-ECL"
use_new_decomp=1
film_mode=full

pretrain_mode=mask
for mask_ratio in 0.1;do
...
> ./run_log/log_202601252110012_win/weather/'TimeDART_pretrain_f'$del_freq_loss'_'$log_var_freq'_o'$del_orth_loss'_'$log_var_orth'_s'$del_smoothness_loss'_'$log_var_smooth'_sea'$del_season_freq_loss'_'$log_var_season_freq'_r'$del_recon_loss'_'$log_var_recon'_mask_ratio'$mask_ratio'_'0.01.log 2>&1
...
python -u run.py \
    ...
    --down_sampling_window 2 \
    --train_epochs 20 \
> ./run_log/log_202601252110012_win/electricity/'TimeDART_pretrain_f'$del_freq_loss'_'$log_var_freq'_o'$del_orth_loss'_'$log_var_orth'_s'$del_smoothness_loss'_'$log_var_smooth'_sea'$del_season_freq_loss'_'$log_var_season_freq'_r'$del_recon_loss'_'$log_var_recon'_mask_ratio'$mask_ratio'_'0.01.log 2>&1
...
echo "ECL $denoise_layers_num _ $pred_len"
    ...
    --use_inner_encoder $use_inner_encoder \
        --down_sampling_window 2 \
        --pct_start 0.3 \
> ./run_log/log_202601252110012_win/electricity/'TimeDART_finetune'$pred_len'_'$denoise_layers_num'_f'$del_freq_loss'_'$log_var_freq'_o'$del_orth_loss'_'$log_var_orth'_s'$del_smoothness_loss'_'$log_var_smooth'_sea'$del_season_freq_loss'_'$log_var_season_freq'_r'$del_recon_loss'_'$log_var_recon'_mask_ratio'$mask_ratio'_'0.01.log 2>&1
...
if [ ! -d "./run_log/log_202601252110012_for0_3_win" ]; then
    mkdir ./run_log/log_202601252110012_for0_3_win
fi
if [ ! -d "./run_log/log_202601252110012_for0_3_win/ETTm1" ]; then
    mkdir ./run_log/log_202601252110012_for0_3_win/ETTm1
fi
if [ ! -d "./run_log/log_202601252110012_for0_3_win/ETTh1" ]; then
    mkdir ./run_log/log_202601252110012_for0_3_win/ETTh1
fi
if [ ! -d "./run_log/log_202601252110012_for0_3_win/ETTm2" ]; then
    mkdir ./run_log/log_202601252110012_for0_3_win/ETTm2
fi

if [ ! -d "./run_log/log_202601252110012_for0_3_win/ETTh2" ]; then
    mkdir ./run_log/log_202601252110012_for0_3_win/ETTh2
fi
if [ ! -d "./run_log/log_202601252110012_for0_3_win/electricity" ]; then
    mkdir ./run_log/log_202601252110012_for0_3_win/electricity
fi

if [ ! -d "./run_log/log_202601252110012_for0_3_win/Exchange" ]; then
    mkdir ./run_log/log_202601252110012_for0_3_win/Exchange
fi

#if [ ! -d "./run_log/log_202601252110012_for0_3_win/Solar" ]; then
#    mkdir ./run_log/log_202601252110012_for0_3_win/Solar
#fi

if [ ! -d "./run_log/log_202601252110012_for0_3_win/weather" ]; then
    mkdir ./run_log/log_202601252110012_for0_3_win/weather
fi

if [ ! -d "./run_log/log_202601252110012_for0_3_win/Traffic" ]; then
    mkdir ./run_log/log_202601252110012_for0_3_win/Traffic
fi
#
#if [ ! -d "./run_log/log_202601252110012_for0_3_win/PEMS03" ]; then
#    mkdir ./run_log/log_202601252110012_for0_3_win/PEMS03
#fi
#
#if [ ! -d "./run_log/log_202601252110012_for0_3_win/PEMS04" ]; then
#    mkdir ./run_log/log_202601252110012_for0_3_win/PEMS04
#fi
#
#if [ ! -d "./run_log/log_202601252110012_for0_3_win/PEMS07" ]; then
#    mkdir ./run_log/log_202601252110012_for0_3_win/PEMS07
#fi
#if [ ! -d "./run_log/log_202601252110012_for0_3_win/PEMS08" ]; then
#    mkdir ./run_log/log_202601252110012_for0_3_win/PEMS08
#fi
...
python -u run.py \
    ...
    --use_inner_encoder $use_inner_encoder \
    --down_sampling_window 2 \
> ./run_log/log_202601252110012_for0_3_win/Exchange/'TimeDART_pretrain_f'$del_freq_loss'_'$log_var_freq'_o'$del_orth_loss'_'$log_var_orth'_s'$del_smoothness_loss'_'$log_var_smooth'_sea'$del_season_freq_loss'_'$log_var_season_freq'_r'$del_recon_loss'_'$log_var_recon'_mask_ratio'$mask_ratio'_'0.01.log 2>&1
...
echo "Exchange $denoise_layers_num _ $pred_len"
    ...
    --use_inner_encoder $use_inner_encoder \
       --down_sampling_window 2 \
> ./run_log/log_202601252110012_for0_3_win/Exchange/'TimeDART_finetune'$pred_len'_'$denoise_layers_num'_f'$del_freq_loss'_'$log_var_freq'_o'$del_orth_loss'_'$log_var_orth'_s'$del_smoothness_loss'_'$log_var_smooth'_sea'$del_season_freq_loss'_'$log_var_season_freq'_r'$del_recon_loss'_'$log_var_recon'_mask_ratio'$mask_ratio'_'0.01.log 2>&1
...
python -u run.py \
    ...
    --use_inner_encoder $use_inner_encoder \
    --down_sampling_window 2 \
> ./run_log/log_202601252110012_for0_3_win/weather/'TimeDART_pretrain_f'$del_freq_loss'_'$log_var_freq'_o'$del_orth_loss'_'$log_var_orth'_s'$del_smoothness_loss'_'$log_var_smooth'_sea'$del_season_freq_loss'_'$log_var_season_freq'_r'$del_recon_loss'_'$log_var_recon'_mask_ratio'$mask_ratio'_'0.01.log 2>&1
...
echo "Weather $denoise_layers_num _ $pred_len"
    ...
    --use_inner_encoder $use_inner_encoder \
    --down_sampling_window 2 \
> ./run_log/log_202601252110012_for0_3_win/weather/'TimeDART_finetune'$pred_len'_'$denoise_layers_num'_f'$del_freq_loss'_'$log_var_freq'_o'$del_orth_loss'_'$log_var_orth'_s'$del_smoothness_loss'_'$log_var_smooth'_sea'$del_season_freq_loss'_'$log_var_season_freq'_r'$del_recon_loss'_'$log_var_recon'_mask_ratio'$mask_ratio'_'0.01.log 2>&1
...
python -u run.py \
    ...
    --down_sampling_window 2 \
    --train_epochs 20 \
> ./run_log/log_202601252110012_for0_3_win/electricity/'TimeDART_pretrain_f'$del_freq_loss'_'$log_var_freq'_o'$del_orth_loss'_'$log_var_orth'_s'$del_smoothness_loss'_'$log_var_smooth'_sea'$del_season_freq_loss'_'$log_var_season_freq'_r'$del_recon_loss'_'$log_var_recon'_mask_ratio'$mask_ratio'_'0.01.log 2>&1
...
echo "ECL $denoise_layers_num _ $pred_len"
    ...
    --use_inner_encoder $use_inner_encoder \
        --down_sampling_window 2 \
        --pct_start 0.3 \
> ./run_log/log_202601252110012_for0_3_win/electricity/'TimeDART_finetune'$pred_len'_'$denoise_layers_num'_f'$del_freq_loss'_'$log_var_freq'_o'$del_orth_loss'_'$log_var_orth'_s'$del_smoothness_loss'_'$log_var_smooth'_sea'$del_season_freq_loss'_'$log_var_season_freq'_r'$del_recon_loss'_'$log_var_recon'_mask_ratio'$mask_ratio'_'0.01.log 2>&1
...
if [ ! -d "./run_log/log_202601252110012_for0_9_win" ]; then
    mkdir ./run_log/log_202601252110012_for0_9_win
fi
if [ ! -d "./run_log/log_202601252110012_for0_9_win/ETTm1" ]; then
    mkdir ./run_log/log_202601252110012_for0_9_win/ETTm1
fi
if [ ! -d "./run_log/log_202601252110012_for0_9_win/ETTh1" ]; then
    mkdir ./run_log/log_202601252110012_for0_9_win/ETTh1
fi
if [ ! -d "./run_log/log_202601252110012_for0_9_win/ETTm2" ]; then
    mkdir ./run_log/log_202601252110012_for0_9_win/ETTm2
fi

if [ ! -d "./run_log/log_202601252110012_for0_9_win/ETTh2" ]; then
    mkdir ./run_log/log_202601252110012_for0_9_win/ETTh2
fi
if [ ! -d "./run_log/log_202601252110012_for0_9_win/electricity" ]; then
    mkdir ./run_log/log_202601252110012_for0_9_win/electricity
fi

if [ ! -d "./run_log/log_202601252110012_for0_9_win/Exchange" ]; then
    mkdir ./run_log/log_202601252110012_for0_9_win/Exchange
fi

#if [ ! -d "./run_log/log_202601252110012_for0_9_win/Solar" ]; then
#    mkdir ./run_log/log_202601252110012_for0_9_win/Solar
#fi

if [ ! -d "./run_log/log_202601252110012_for0_9_win/weather" ]; then
    mkdir ./run_log/log_202601252110012_for0_9_win/weather
fi

if [ ! -d "./run_log/log_202601252110012_for0_9_win/Traffic" ]; then
    mkdir ./run_log/log_202601252110012_for0_9_win/Traffic
fi
#
#if [ ! -d "./run_log/log_202601252110012_for0_9_win/PEMS03" ]; then
#    mkdir ./run_log/log_202601252110012_for0_9_win/PEMS03
#fi
#
#if [ ! -d "./run_log/log_202601252110012_for0_9_win/PEMS04" ]; then
#    mkdir ./run_log/log_202601252110012_for0_9_win/PEMS04
#fi
#
#if [ ! -d "./run_log/log_202601252110012_for0_9_win/PEMS07" ]; then
#    mkdir ./run_log/log_202601252110012_for0_9_win/PEMS07
#fi
#if [ ! -d "./run_log/log_202601252110012_for0_9_win/PEMS08" ]; then
#    mkdir ./run_log/log_202601252110012_for0_9_win/PEMS08
#fi
...
python -u run.py \
    ...
    --use_inner_encoder $use_inner_encoder \
    --down_sampling_window 2 \
> ./run_log/log_202601252110012_for0_9_win/ETTm2/'TimeDART_pretrain_f'$del_freq_loss'_'$log_var_freq'_o'$del_orth_loss'_'$log_var_orth'_s'$del_smoothness_loss'_'$log_var_smooth'_sea'$del_season_freq_loss'_'$log_var_season_freq'_r'$del_recon_loss'_'$log_var_recon'_mask_ratio'$mask_ratio'_'0.01.log 2>&1
...
echo "ETTm2 $denoise_layers_num _ $pred_len"
    ...
    --use_inner_encoder $use_inner_encoder \
       --down_sampling_window 2 \
> ./run_log/log_202601252110012_for0_9_win/ETTm2/'TimeDART_finetune'$pred_len'_'$denoise_layers_num'_f'$del_freq_loss'_'$log_var_freq'_o'$del_orth_loss'_'$log_var_orth'_s'$del_smoothness_loss'_'$log_var_smooth'_sea'$del_season_freq_loss'_'$log_var_season_freq'_r'$del_recon_loss'_'$log_var_recon'_mask_ratio'$mask_ratio'_'0.01.log 2>&1
...
python -u run.py \
    ...
    --use_inner_encoder $use_inner_encoder \
    --down_sampling_window 2 \
> ./run_log/log_202601252110012_for0_9_win/Exchange/'TimeDART_pretrain_f'$del_freq_loss'_'$log_var_freq'_o'$del_orth_loss'_'$log_var_orth'_s'$del_smoothness_loss'_'$log_var_smooth'_sea'$del_season_freq_loss'_'$log_var_season_freq'_r'$del_recon_loss'_'$log_var_recon'_mask_ratio'$mask_ratio'_'0.01.log 2>&1
...
echo "Exchange $denoise_layers_num _ $pred_len"
    ...
    --use_inner_encoder $use_inner_encoder \
       --down_sampling_window 2 \
> ./run_log/log_202601252110012_for0_9_win/Exchange/'TimeDART_finetune'$pred_len'_'$denoise_layers_num'_f'$del_freq_loss'_'$log_var_freq'_o'$del_orth_loss'_'$log_var_orth'_s'$del_smoothness_loss'_'$log_var_smooth'_sea'$del_season_freq_loss'_'$log_var_season_freq'_r'$del_recon_loss'_'$log_var_recon'_mask_ratio'$mask_ratio'_'0.01.log 2>&1
...
python -u run.py \
    ...
    --use_inner_encoder $use_inner_encoder \
    --down_sampling_window 2 \
> ./run_log/log_202601252110012_for0_9_win/weather/'TimeDART_pretrain_f'$del_freq_loss'_'$log_var_freq'_o'$del_orth_loss'_'$log_var_orth'_s'$del_smoothness_loss'_'$log_var_smooth'_sea'$del_season_freq_loss'_'$log_var_season_freq'_r'$del_recon_loss'_'$log_var_recon'_mask_ratio'$mask_ratio'_'0.01.log 2>&1
...
echo "Weather $denoise_layers_num _ $pred_len"
    ...
    --use_inner_encoder $use_inner_encoder \
    --down_sampling_window 2 \
> ./run_log/log_202601252110012_for0_9_win/weather/'TimeDART_finetune'$pred_len'_'$denoise_layers_num'_f'$del_freq_loss'_'$log_var_freq'_o'$del_orth_loss'_'$log_var_orth'_s'$del_smoothness_loss'_'$log_var_smooth'_sea'$del_season_freq_loss'_'$log_var_season_freq'_r'$del_recon_loss'_'$log_var_recon'_mask_ratio'$mask_ratio'_'0.01.log 2>&1
...
python -u run.py \
    ...
    --down_sampling_window 2 \
    --train_epochs 20 \
> ./run_log/log_202601252110012_for0_9_win/electricity/'TimeDART_pretrain_f'$del_freq_loss'_'$log_var_freq'_o'$del_orth_loss'_'$log_var_orth'_s'$del_smoothness_loss'_'$log_var_smooth'_sea'$del_season_freq_loss'_'$log_var_season_freq'_r'$del_recon_loss'_'$log_var_recon'_mask_ratio'$mask_ratio'_'0.01.log 2>&1
...
echo "ECL $denoise_layers_num _ $pred_len"
    ...
    --use_inner_encoder $use_inner_encoder \
        --down_sampling_window 2 \
        --pct_start 0.3 \
> ./run_log/log_202601252110012_for0_9_win/electricity/'TimeDART_finetune'$pred_len'_'$denoise_layers_num'_f'$del_freq_loss'_'$log_var_freq'_o'$del_orth_loss'_'$log_var_orth'_s'$del_smoothness_loss'_'$log_var_smooth'_sea'$del_season_freq_loss'_'$log_var_season_freq'_r'$del_recon_loss'_'$log_var_recon'_mask_ratio'$mask_ratio'_'0.01.log 2>&1
